...
import com.night.bi.mapper.UserMapper;
import com.night.bi.model.dto.user.UserQueryRequest;
import com.night.bi.model.entity.User;
import com.night.bi.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "night";
    ...
    public LoginUserVO userLogin(String userAccount, String userPassword, HttpServletRequest request) {
        ...
        if (userAccount.length() < 4) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "帐号错误");
        }
