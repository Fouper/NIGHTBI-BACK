...
import static com.night.bi.mq.MqConstant.QUEUE_NAME;
...
public class MessageConsumer {
    ...
    public void receiveMessage(String message, Channel channel, @Header(AmqpHeaders.DELIVERY_TAG) long deliveryTag) {
        ...
        String result = aiManager.getContents(CommonConstant.BI_MODEL_ID, handleUserInput(chart));
